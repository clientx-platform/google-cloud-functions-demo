...
const Clientx = require('node');
const isDev = process.env.NODE_ENV !== 'production'
// Replace with your API_ACCESS_TOKEN
const API_ACCESS_TOKEN = '';
// Replace with your clientx host URL
const APP_HOST = isDev ? 'http://localhost:3000' : 'https://app.clientx.io';
// Replace with your account id
const ACCOUNT_ID = 1;
const ClientxClient = new Clientx({ config: { host: APP_HOST, apiAccessToken: API_ACCESS_TOKEN } })
const Conversations = ClientxClient.conversations(ACCOUNT_ID)
...
exports.parseClientxWebhook = functions.https.onRequest((request, response) => {
